...
frameWorksParams = SimulationFrameworkParams('numSteps',Inf,'showSimulation',true,'dt',0.1,...
                    'numChains',10,'objectInteraction',false,'dimension',3,'recipeFileName',...
                    'rcpTestParticleDetachmentFromDomain');
...
%                    'diffusionConst',diffConst,'fixedBeadNum',32,'beadsOnBoundary',[1 64]);
% 
%      
%                
