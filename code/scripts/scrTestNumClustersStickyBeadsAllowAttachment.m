%this test is used to test the number of clusters of sticky beads while
%allow other beads inside the domain to attach on the boundary;
...
chainForce  = ForceManagerParams('springForce',true,'diffusionForce',true,'diffusionConst',diffConst,...
 ...
 cp(1)= ChainParams('numBeads',65,'initializeInDomain',1,'springForce',true,...
                   ...
                   'beadsOnBoundary',[1 65],'stickyBeads',[1,65],'allowAttachToBoundary',false);
