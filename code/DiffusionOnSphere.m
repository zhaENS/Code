...
% paths(2:end,:) = radius.*(bsxfun(@minus,paths(2:end,:),domainCenter))...
%                  .*sqrt(1./(bsxfun(@minus,paths(2:end,1),domainCenter).^2 ...
%                   +bsxfun(@minus,paths(2:end,2),domainCenter).^2+ ...
%                    bsxfun(@minus,paths(2:end,3),domainCenter)));
