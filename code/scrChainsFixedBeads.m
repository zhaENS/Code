...
cp(1)= ChainParams('numBeads',10,'b',1,'initializeInDomain',1,'springForce',true,...
                   'fixedBeadNum',[1 5 8],'forceParams',chainForce,'dt',frameWorksParams.simulator.dt,...
                   'fixedBeadNum',[1 5 10],'beadsOnBoundary',[1 5 10]);
...
% cp(1).fixedBeadsPosition = initialChainPosition(cp(1).fixedBeadNum(2),:);
% cp(2).fixedBeadsPosition = cp(1).fixedBeadsPosition;
% cp(3).fixedBeadsPosition = cp(1).fixedBeadsPosition;
