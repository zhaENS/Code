...
cp(3)= ChainParams('numBeads',64,'b',sqrt(frameWorksParams.simulator.dimension),'initializeInDomain',1,'springForce',true,...
                   ...
                   'diffusionConst',diffConst,'fixedBeadNum',32,'beadsOnBoundary',[1 64],'stickyBeads',[1:10:64]);
...
cp(6)= ChainParams('numBeads',64,'b',sqrt(frameWorksParams.simulator.dimension),'initializeInDomain',1,'springForce',true,...
 ...
 cp(9)= ChainParams('numBeads',64,'b',sqrt(frameWorksParams.simulator.dimension),'initializeInDomain',1,'springForce',true,...
                   'diffusionConst',diffConst,'forceParams',chainForce,'dt',frameWorksParams.simulator.dt,'fixedBeadsPosition',initialPt,...
                   'fixedBeadNum',32,'beadsOnBoundary',[1 64],'stickyBeads',[64]);

 cp(10)= ChainParams('numBeads',64,'b',sqrt(frameWorksParams.simulator.dimension),'initializeInDomain',1,'springForce',true,...
                   'diffusionConst',diffConst,'forceParams',chainForce,'dt',frameWorksParams.simulator.dt,'fixedBeadsPosition',initialPt,...
                   'fixedBeadNum',32,'beadsOnBoundary',[1 64],'stickyBeads',[64]);
